...
1. this branch depends on hbase 0.96.2 with hadoop.version=2.2.0. We need download source code of hbase 0.96.2 and install in maven local repository by(in the directory of hbase 0.96.2):
...
3. start a standalone HBase cluster(0.96.2 with hadoop.version=2.2.0) and make sure themis-coprocessor is loaded as above steps.
